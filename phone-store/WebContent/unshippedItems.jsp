...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold;">Đơn hàng đang xử lý ...</div>
				...
				<tbody style="background-color: white;">
					...
					<tr>
						...
						<td><a
							...
							class="btn btn-success">Giao bây giờ</a></td>
					</tr>
					...
					<tr style="background-color: grey; color: white;">
						<td colspan="7" style="text-align: center;">Không tồn tại vật phẩm</td>
