...
<body style="background-color: #E6F9E6;">
	...
	<div class="container">
		<div class="row"
			style="margin-top: 75px; margin-left: 2px; margin-right: 2px;">
			<form action="./LoginSrv" method="post"
				class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2"
				style="border: 2px solid skyblue; border-radius: 10px; background-color: #abaed4; padding: 10px;">
				<div style="font-weight: bold;" class="text-center">
				<img class="logo" src="images/logo-1.png">
					<h2 style="font-size: 36px; font-family: sans-serif;">Login</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
