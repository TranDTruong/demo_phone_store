...
<body style="background-color: #E6F9E6;">
	...
	if (user == null)
		user = new UserBean("NamTruong", "0928122322", "namtruong@gmail.com", "HaNoi", 99999, "lksdjf");
	%>
			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-body text-center">
						<img src="images/child.jpg" class="rounded-circle img-fluid"
							style="width: 150px;">
						<h5 class="my-3">
							Xin chào
							<%=user.getName()%>
