		...
		<div class="row"
			...
			<form action="./AddProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: green;">Mẫu bổ sung màn hình</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Tên sản phẩm</label> <input type="text"
							placeholder="Tên" name="name" class="form-control"
					...
					<div class="col-md-6 form-group">
						<label for="producttype">Loại sản phẩm</label> <select name="type"
							...
							<option value="other">Một số sản phẩm khác</option>
						</select>
					</div>
				</div>
				...
				<div>
					<div class="col-md-12 form-group">
						<label for="last_name">Ảnh sản phẩm</label> <input type="file"
							placeholder="Chọn ảnh" name="image" class="form-control"
							id="last_name" required>
					</div>
				</div>
				<div class="row">
