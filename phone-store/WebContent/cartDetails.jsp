...
<body style="background-color: #E6F9E6;">
	...
	if (userName == null || password == null) {
		...
		response.sendRedirect("login.jsp?message=Đăng nhập lại");
		...
		<table class="table table-hover">
			...
			<tbody
				...
				<tr>
					...
					<td><fmt:formatNumber type="number" value="<%=product.getProdPrice()%>"></fmt:formatNumber></td>
				...
				<tr style="background-color: grey; color: white;">
					<td colspan="6" style="text-align: center;">Tổng số tiền phải trả</td>
					<td><fmt:formatNumber type="number" value="<%=totAmount%>"></fmt:formatNumber></td>
				</tr>
				<%
				if (totAmount != 0) {
				%>
				<tr style="background-color: grey; color: white;">
					...
					<td colspan="2" align="center"><form method="post">
							<button style="background-color: blue; color: white;"
								formaction="payment.jsp?amount=<%=totAmount%>">Thanh toán bây giờ</button>
						</form></td>
